...
export const DSTR = {
  en: {
    ...
    linkOnTheWay: 'If that address belongs to someone here, a link is on its way. Open the newest email you have — it works once, expires in an hour, and asking again cancels the one before it. Check your junk folder if it is not there.',
    ...
    linkExpiredWhy: 'Sign-in links last an hour and work once, and every new link cancels the one before it — so an older email in your inbox will always say this. Open the newest one, or send yourself a fresh link and use that. Some mail scanners also open links before you do, which uses them up.',
  ...
  ar: {
    ...
    linkOnTheWay: 'إن كان هذا البريد يخص أحداً هنا، فالرابط في طريقه إليك. افتح أحدث رسالة وصلتك — الرابط يعمل مرة واحدة، وتنتهي صلاحيته خلال ساعة، وكل طلب جديد يُلغي السابق. راجع مجلد الرسائل غير المرغوبة إن لم تجدها.',
    ...
    linkExpiredWhy: 'روابط الدخول تعمل مرة واحدة ولمدة ساعة، وكل رابط جديد يُلغي ما قبله — لذا ستظهر هذه الرسالة دائماً مع أي بريد أقدم. افتح أحدث رسالة، أو أرسل لنفسك رابطاً جديداً واستخدمه. كما أن بعض أنظمة فحص البريد تفتح الرابط قبلك فتستهلكه.',
